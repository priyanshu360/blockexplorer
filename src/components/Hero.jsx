function Hero() {
	return <section className="flex bg-gray-100 items-center  justify-center">
		<div className="my-36 max-w-3xl w-full px-6 text-center">
			...
			<form className="flex items-center mt-8 w-4/5 space-x-4 mx-auto">
				<input type="text" placeholder="Search by Address, Txn Hash, Block, or Token" className=" h-12 px-4 flex-1 rounded-lg border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent" />
